...
Int_t nBinsKSestimate         = 50;      // number of bins to be used in the 0.4-1.4 window for KS estimate
...
void          IterativeFitting(Int_t iIter, const Int_t nSlice, const Double_t ptMin, const Double_t ptMax, TString fileIn, TString readSmooth, TString readSamp);
...
void PIDIterativeFitting(Int_t sign, TString fileData, const Int_t nSlice, Double_t ptMin, Double_t ptMax, Int_t maxIter=8, Double_t piSkewnessScanIn=0.8, Double_t kaSkewnessScanIn=0.5, Double_t prSkewnessScanIn=0.5, Double_t piKurtosisScanIn=1., Double_t kaKurtosisScanIn=1., Double_t prKurtosisScanIn=1.)
{
  ...
  cd  /lustre/nyx/alice/users/marsland/pFluct/files/analysis/Data/PbPb/Real/Systematics_cRows_80_16EtaBin_mombin20MeV/Fits/test
  aliroot -l -b
  .L /u/marsland/PHD/macros/marsland_EbyeRatios/PIDIterativeFitting.C+
  PIDIterativeFitting(1,"../../Hists/Hists_PbPb_eta_-0.10_0.00_cent_30.00_40.00.root",100,0.2,2.2,7,0.7,0.5,0.5,1,1,1);  2> err.log
...
//     Int_t previousIter = iIter-1;
    ...
    IterativeFitting(iIter,nSlice,ptMin,ptMax,fileFit,readSmooth,fileSample);
...
// -------------------------------------------------------------------------------------------------------
void IterativeFitting(Int_t iIter, const Int_t nSlice, const Double_t ptMin, const Double_t ptMax, TString fileFit, TString readSmooth, TString readSamp)
{
  ...
  for (Int_t islice = 0; islice<nSlice; islice++){  
   ...
   // find bins to be used in the projection
    ...
    TF1 *total = new TF1("total","g1+g2+g3+g4",dEdxMin,dEdxMax); total->SetNpx(1000); total->SetLineWidth(3); total->SetLineColor(2);
