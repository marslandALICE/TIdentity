...
AliAnalysisTask *AddTask_marsland_TIdentityPID(Bool_t getFromAlien=kFALSE,TString configFileName = "Config_marsland_TIdentityPID.C",Int_t settingType = 0,Int_t lhcPeriod = 1, Int_t lookUpTableIndex = 1)
{
  //
   ...
   */
  std::cout << " Info::marsland: ===== In the AddTask_marsland_TIdentityPID ===== " << std::endl;
  if (!getFromAlien) {
    settingType = 4;   // 4 for Real data 100 for full MC
    lhcPeriod = 2;
    lookUpTableIndex =1;
  }
  ...
  AliAnalysisDataContainer *coutput5, *coutput6, *coutput7, *coutput8, *coutput9, *coutput10, *coutput11, *coutput12, *coutput13, *coutput14, *coutput15, *coutput16, *coutput17;
  ...
  coutput11 = mgr->CreateContainer("tracks",        TTree::Class(), AliAnalysisManager::kOutputContainer ,results.Data());
  ...
  coutput16 = mgr->CreateContainer("events",        TTree::Class(), AliAnalysisManager::kOutputContainer ,results.Data());
  coutput17 = mgr->CreateContainer("dscaled",       TTree::Class(), AliAnalysisManager::kOutputContainer ,results.Data());
