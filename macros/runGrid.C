...
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/badrunsFillDep-2015-LHC15o-pass1.list","TPC_dEdx_Info")' &> stdout &
aliroot -b -q 'runGrid.C(0,"full",1,"$RUN_ON_GRID_DIR/Ebye/lists/badrunsFillDep-2015-LHC15o-pass1.list","TimeBinQAFillDep")'

aliroot -b -q 'runGrid.C(3,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2015-LHC15o-pass5_lowIR.list","TPC_dEdx_Info")' &> stdout &


// ----------------------------------------------------------------------------------------------------------------------------------------
// tests real data
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runForMCcomp-2015-LHC15o-pass1.list","TPC_dEdx_Info",0,21,2)'
// ----------------------------------------------------------------------------------------------------------------------------------------
// tests real data
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2015-LHC15o-pass5_lowIR.list","TPC_dEdx_Info",0,4,2)' &> stdout &
// ----------------------------------------------------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------------------------------------------
// tests RUN2 MC full
// void runGrid(valgrindOption, mode, localOrGrid, list, fname, isMC, setType, lhcPeriod)
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2016-LHC16d2-pass1.list","TPC_dEdx_Info",1,50,2)'          //  EPOS
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2016-LHC16k3b-pass3.list","TPC_dEdx_Info",1,50,2)'         //  HIJING with pileup anchored to 15o (pass3)
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2016-LHC16k3b2-pass3.list","TPC_dEdx_Info",1,50,2)'        //  HIJING no pile-up
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2017-LHC17c5b-pass5_lowIR.list","TPC_dEdx_Info",1,50,2)'   //  HIJING anchored to Low IR runs LHC15o (pass5)
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2016-LHC16g1-pass1.list","TPC_dEdx_Info",1,50,2)'          //  HIJING min bias - anchored to LHC15o (pass1 highIR)
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2017-LHC17i2-pass1.list","TPC_dEdx_Info",1,50,2)'          //  AMPT (via AliGenerators) for Pb-Pb 5.02 TeV, LHC15o, ALIROOT-7338
// ----------------------------------------------------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------------------------------------------
// tests RUN2 MC Fast
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2016-LHC16k3b-pass3.list","TPC_dEdx_Info",2,111,2)'

// tests RUN2 Real 15o Pass1
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2015-LHC15o-pass1.list","Distortion_vs_PID",0,4,2)'
aliroot -b -q 'runGrid.C(0,"full",1,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2015-LHC15o-pass1.list","Distortion_vs_PID",0,4,2)'
// ----------------------------------------------------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------------------------------------------
// tests RUN1 MC full
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2010-LHC11a10a_bis-pass1.list","TPC_dEdx_Info",3,50,1)'
// ----------------------------------------------------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------------------------------------------
// tests RUN1 MC fast
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/Ebye/lists/runs-2013-LHC13f3b-pass1.list","TPC_dEdx_Info",4,111,1)'
...
aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/ESD_Filtering/lists/runs-2010-LHC10h-pass2.list","TPC_dEdx_Info",0,21,1)'

aliroot -b -q 'runGrid.C(0,"test",0,"$RUN_ON_GRID_DIR/ESD_Filtering/lists/runs-2011-LHC11h_2-pass2.list","TPC_dEdx_Info",0,21,1)'
...
void runGrid(Int_t valgrindOption = 0, TString mode="test",Int_t localOrGrid=0, TString list = "$RUN_ON_GRID_DIR/Ebye/lists/test-2015-LHC15o-pass5_lowIR.list", TString fname="EbyeIterPID", Int_t isMC=0, Int_t setType=109, Int_t lhcPeriod=1)
{
  //
  // valgrindOption --> 0 --> Normal, 1--> valgrind, 2--> callgrind, 3-->Massif
  // mode           --> "test" or "full" or "terminate"
  ...
  if (!(isMC==2 || isMC==4)){
    ...
    if (isMC==0) taskPID=AddTaskPIDResponse(kTRUE,kTRUE,kFALSE);
    if (isMC==1 || isMC==3) taskPID=AddTaskPIDResponse(kTRUE,kTRUE,kTRUE);
