#!/bin/sh
    ...
    export ALIBUILD_WORK_DIR="${SINGULARITY_PREFIX}/alidockSingularity/o2sw/sw"
    eval "`alienv shell-helper`"
    alias alio2='alienv load O2/latest-dev-o2; alienv list'
    ...
    export GARFIELD_HOME=/home/marsland/garfield
    export HEED_DATABASE=$GARFIELD_HOME/Heed/heed++/database
    export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/marsland/garfield/build/lib

    ## TIdentity
    #export TIdentityDIR=/home/marsland/Desktop/ubuntu_desktop/workdir/TIdentityCMake_Dev
    export TIdentityDIR=/home/marsland/Desktop/ubuntu_desktop/workdir/lustre/nyx/alice/users/marsland/workdir/TIdentityCMake_Dev
    ...
    if [ "$color_prompt" = yes ]; then
        PS1='<o2Sing> ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
    else
